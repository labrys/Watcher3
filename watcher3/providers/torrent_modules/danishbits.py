...
def search(imdbid, term, ignore_if_imdbid_cap = False):
    ...
    username = watcher3.CONFIG['Indexers']['PrivateTorrent']['danishbits']['username']
    passkey = watcher3.CONFIG['Indexers']['PrivateTorrent']['danishbits']['passkey']
    ...
    try:
        ...
        if proxy_enabled and watcher3.proxy.whitelist('https://danishbits.org') is True:
