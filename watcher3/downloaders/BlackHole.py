...
from watcher3.helpers import Torrent as th
...
def add_nzb(data):
    ...
    conf = watcher3.CONFIG['Downloader']['Usenet']['BlackHole']
...
def add_torrent(data):
    ...
    conf = watcher3.CONFIG['Downloader']['Torrent']['BlackHole']
...
def _download_magnet(data, path):
    ...
    The downloaded content is ran through bencode (via watcher3.helpers.Torrent) to
