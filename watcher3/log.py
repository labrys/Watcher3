...
def start(path, stdout=False):
    ...
    file_handler = logging.handlers.TimedRotatingFileHandler(logfile, when='D', interval=1, backupCount=watcher3.CONFIG['Server']['keeplog'], encoding='utf-8')
    file_handler.setFormatter(formatter)
    file_handler.setLevel(0 if watcher3.CONFIG['Server']['debuglog'] else 20)
